...
import 'package:gallery/icons/icons.dart';
  ...
  Widget build(BuildContext context) {
    final pages = [
      _ListItem(
        ...
        subtitle: const Text('All of the predefined icons'),
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Orb App UI Gallery')),
